...
# scopusFileListFileNameOnDisk = "scopus_file_list.csv"
scopusFileListFileNameOnDisk = "scopusJournalList.csv"
sciFileListNameOnDiskPrefix  = "sciJournalList" # ohne .csv
ssciFileListNameOnDiskPrefix  = "ssciJournalList" # ohne .csv
